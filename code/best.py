...
logging.basicConfig(filename = 'best.log', level = logging.INFO) #Logging
...
X_errInt = np.zeros(6) #Initalization of error integration
x = Tse
...
np.savetxt('Best.csv', realConfig, delimiter=',')
