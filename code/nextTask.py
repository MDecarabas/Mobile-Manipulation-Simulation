...
logging.basicConfig(filename = 'nextTask.log', level = logging.INFO) #Logging
...
Tsc_goal = np.array([[0, 1, 0, 1.5], #Goal Position of Cube
                    [-1, 0, 0, -1.5],
                    [0, 0, 1, 0.025],
                    [0, 0, 0, 1]])
...
np.savetxt('nextTask.csv', realConfig, delimiter=',')
np.savetxt('x_err_newState.csv', x_err, delimiter=',')
